...
["stanza22.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "PREFIX brso: <http://purl.jp/bio/10/brso/>\nPREFIX sio: <http://semanticscience.org/resource/>\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\nPREFIX dct: <http://purl.org/dc/terms/>\nPREFIX bmpo: <http://purl.bioontology.org/ontology/BMPO/>\n\nSELECT distinct ?id (group_concat(distinct ?phenotype;separator = \", \") AS ?phenotype) (group_concat(distinct ?reference ;separator = \", \") AS ?reference) (group_concat(distinct ?derived_from;separator = \", \") AS ?derived_from)\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm>\nWHERE {\n    {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            dcterms:isReferencedBy ?reference ;\n            brso:derived_from ?derived_from ;\n            bmpo:stage_egg ?StageResource .\n        ?StageResource a brso:BiologicalResourceEgg ;\n            sio:SIO_001279 _:b1 .\n        _:b1 a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '')\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            dcterms:isReferencedBy ?reference ;\n            brso:derived_from ?derived_from ;\n            bmpo:stage_egg ?StageResource .\n        ?StageResource a brso:BiologicalResourceEgg ;\n            sio:SIO_001279 _:b11 .\n        _:b11 a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '')\n\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            dcterms:isReferencedBy ?reference ;\n            brso:derived_from ?derived_from ;\n            bmpo:stage_larva ?StageResource .\n        ?StageResource a brso:BiologicalResourceLarva ;\n            sio:SIO_001279 _:b2 .\n        _:b2 a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '')\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            dcterms:isReferencedBy ?reference ;\n            brso:derived_from ?derived_from ;\n            bmpo:stage_larva ?StageResource .\n        ?StageResource a brso:BiologicalResourceLarva ;\n            sio:SIO_001279 _:b22 .\n        _:b22 a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '')\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            dcterms:isReferencedBy ?reference ;\n            brso:derived_from ?derived_from ;\n            bmpo:stage_larva ?StageResource .\n        ?StageResource a brso:BiologicalResourceLarva ;\n            sio:SIO_001279 _:b2 .\n        _:b2 a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"language") || (depth0 != null ? lookupProperty(depth0,"language") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"language","hash":{},"data":data,"loc":{"start":{"line":65,"column":35},"end":{"line":65,"column":47}}}) : helper))) != null ? stack1 : "")
    + "')\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            dcterms:isReferencedBy ?reference ;\n            brso:derived_from ?derived_from ;\n            bmpo:stage_larva ?StageResource .\n        ?StageResource a brso:BiologicalResourceLarva ;\n            sio:SIO_001279 _:b22 .\n        _:b22 a sio:SIO_010056 ;\n            rdfs:label ?phenotype .\n        filter(LANG(?phenotype) = '"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"language") || (depth0 != null ? lookupProperty(depth0,"language") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"language","hash":{},"data":data,"loc":{"start":{"line":76,"column":35},"end":{"line":76,"column":47}}}) : helper))) != null ? stack1 : "")
    ...
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":137,"column":38},"end":{"line":137,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_egg ?StageResource .\n                ?StageResource a brso:BiologicalResourceEgg ;\n                    sio:SIO_001279 _:b55 .\n                _:b55 a sio:SIO_010056 ;\n                    rdfs:seeAlso ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":148,"column":38},"end":{"line":148,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_larva ?StageResource .\n                ?StageResource a brso:BiologicalResourceLarva ;\n                    sio:SIO_001279 _:b6 .\n                _:b6 a sio:SIO_010056 ;\n                    sio:SIO_000255 ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":160,"column":38},"end":{"line":160,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_larva ?StageResource .\n                ?StageResource a brso:BiologicalResourceLarva ;\n                    sio:SIO_001279 _:b66 .\n                _:b66 a sio:SIO_010056 ;\n                    rdfs:seeAlso ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":171,"column":38},"end":{"line":171,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_pupa ?StageResource .\n                ?StageResource a brso:BiologicalResourcePupa ;\n                    sio:SIO_001279 _:b7 .\n                _:b7 a sio:SIO_010056 ;\n                    sio:SIO_000255 ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":183,"column":38},"end":{"line":183,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_pupa ?StageResource .\n                ?StageResource a brso:BiologicalResourcePupa ;\n                    sio:SIO_001279 _:b77 .\n                _:b77 a sio:SIO_010056 ;\n                    rdfs:seeAlso ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":194,"column":38},"end":{"line":194,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_adult ?StageResource .\n                ?StageResource a brso:BiologicalResourceAdult ;\n                    sio:SIO_001279 _:b8 .\n                _:b8 a sio:SIO_010056 ;\n                    sio:SIO_000255 ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":206,"column":38},"end":{"line":206,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    dcterms:isReferencedBy ?reference ;\n                    brso:derived_from ?derived_from ;\n                    bmpo:stage_adult ?StageResource .\n                ?StageResource a brso:BiologicalResourceAdult ;\n                    sio:SIO_001279 _:b88 .\n                _:b88 a sio:SIO_010056 ;\n                    rdfs:seeAlso ?class .\n                filter regex(?class, \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":217,"column":38},"end":{"line":217,"column":45}}}) : helper))) != null ? stack1 : "")
    + "\", \"i\")\n            }\n        }\n    }\n}\nORDER BY ?id\n";
},"useData":true}]
];
