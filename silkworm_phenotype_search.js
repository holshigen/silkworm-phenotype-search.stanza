...
["stanza22.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "PREFIX brso: <http://purl.jp/bio/10/brso/>\nPREFIX sio: <http://semanticscience.org/resource/>\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\nPREFIX dct: <http://purl.org/dc/terms/>\nPREFIX bmpo: <http://purl.bioontology.org/ontology/BMPO/>\n\nSELECT distinct ?id (group_concat(distinct ?phenotype;separator = \", \") AS ?phenotype) (group_concat(distinct ?reference ;separator = \",\") AS ?reference) (group_concat(distinct ?derived_from;separator = \", \") AS ?derived_from)\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm>\nWHERE {\n    {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            bmpo:stage_egg ?StageResource .\n        ?StageResource a brso:BiologicalResourceEgg ;\n            sio:SIO_001279 _:b1 .\n        filter(LANG(?phenotype) = '')\n        OPTIONAL {?Resource dcterms:isReferencedBy ?reference .}\n        OPTIONAL {?Resource brso:derived_from ?derived_from .}\n        OPTIONAL {\n            _:b1 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n        }\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            bmpo:stage_larva ?StageResource .\n        ?StageResource a brso:BiologicalResourceLarva ;\n            sio:SIO_001279 _:b2 .\n        filter(LANG(?phenotype) = '')\n        OPTIONAL {?Resource dcterms:isReferencedBy ?reference .}\n        OPTIONAL {?Resource brso:derived_from ?derived_from .}\n        OPTIONAL {\n            _:b2 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n        }\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            bmpo:stage_pupa ?StageResource .\n        ?StageResource a brso:BiologicalResourcePupa ;\n            sio:SIO_001279 _:b3 .\n        filter(LANG(?phenotype) = '')\n        OPTIONAL {?Resource dcterms:isReferencedBy ?reference .}\n        OPTIONAL {?Resource brso:derived_from ?derived_from .}\n        OPTIONAL {\n            _:b3 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n        }\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dct:identifier ?id ;\n            bmpo:stage_adult ?StageResource .\n        ?StageResource a brso:BiologicalResourceAdult ;\n            sio:SIO_001279 _:b4 .\n        filter(LANG(?phenotype) = '')\n        OPTIONAL {?Resource dcterms:isReferencedBy ?reference .}\n        OPTIONAL {?Resource brso:derived_from ?derived_from .}\n        OPTIONAL {\n            _:b4 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n        }\n    }\n    {\n        SELECT distinct ?id\n        WHERE {\n            {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_egg ?StageResource .\n                ?StageResource a brso:BiologicalResourceEgg ;\n                    sio:SIO_001279 _:b6 .\n                _:b6 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":73,"column":36},"end":{"line":73,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_egg ?StageResource .\n                ?StageResource a brso:BiologicalResourceEgg ;\n                    sio:SIO_001279 _:b7 .\n                _:b7 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":81,"column":34},"end":{"line":81,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_larva ?StageResource .\n                ?StageResource a brso:BiologicalResourceLarva ;\n                    sio:SIO_001279 _:b8 .\n                _:b8 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":89,"column":36},"end":{"line":89,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_larva ?StageResource .\n                ?StageResource a brso:BiologicalResourceLarva ;\n                    sio:SIO_001279 _:b9 .\n                _:b9 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":97,"column":34},"end":{"line":97,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_pupa ?StageResource .\n                ?StageResource a brso:BiologicalResourcePupa ;\n                    sio:SIO_001279 _:b10 .\n                _:b10 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":105,"column":36},"end":{"line":105,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_pupa ?StageResource .\n                ?StageResource a brso:BiologicalResourcePupa ;\n                    sio:SIO_001279 _:b11 .\n                _:b11 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":113,"column":34},"end":{"line":113,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_adult ?StageResource .\n                ?StageResource a brso:BiologicalResourceAdult ;\n                    sio:SIO_001279 _:b12 .\n                _:b12 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":121,"column":36},"end":{"line":121,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_adult ?StageResource .\n                ?StageResource a brso:BiologicalResourceAdult ;\n                    sio:SIO_001279 _:b13 .\n                _:b13 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":129,"column":34},"end":{"line":129,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {    \n                ?Resource a brso:BiologicalResource ;  \n                    dct:identifier ?id ;  \n                    bmpo:stage_larva ?StageResource .  \n                ?StageResource a brso:BiologicalResourceLarva ;  \n                    sio:SIO_001279 _:b14 .  \n                _:b14 a <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":136,"column":25},"end":{"line":136,"column":32}}}) : helper))) != null ? stack1 : "")
    + "> .    \n            } UNION {  \n                ?Resource a brso:BiologicalResource ;  \n                    dct:identifier ?id ;  \n                    bmpo:stage_larva ?StageResource .  \n                ?StageResource a brso:BiologicalResourceLarva ;  \n                    sio:SIO_001279 _:b15 .  \n                _:b15 a bmpo:LarvaPeriod ;\n                    ?bmpo_property _:16 .\n                _:16 a <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":145,"column":24},"end":{"line":145,"column":31}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } \n        }\n    }\n}\nORDER BY ?id\n";
},"useData":true}]
];
