...
["stanza22.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "DEFINE sql:select-option \"order\"\nPREFIX brso: <http://purl.jp/bio/10/brso/>\nPREFIX sio: <http://semanticscience.org/resource/>\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\nPREFIX dct: <http://purl.org/dc/terms/>\nPREFIX bmpo: <http://purl.bioontology.org/ontology/BMPO/>\n\nSELECT DISTINCT\n    ?Resource\n    ?id\n    (group_concat(distinct ?phenotype;separator = \", \") AS ?phenotype)\n    (group_concat(distinct ?journal ;separator = \",\") AS ?journal)\n    (group_concat(distinct ?origin;separator = \", \") AS ?origin)\nFROM <"
    ...
    + ">\nWHERE {\n    {\n        ?Resource a brso:BiologicalResource ;\n            dcterms:identifier ?id ;\n            bmpo:stage_egg ?StageEgg .\n        ?StageEgg a brso:BiologicalResourceEgg .\n        \n        OPTIONAL {?Resource dcterms:isReferencedBy ?journal .}\n        OPTIONAL {?Resource brso:derived_from ?origin .}\n        OPTIONAL {\n            ?StageEgg sio:SIO_001279 _:b1 .\n            _:b1 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n            filter(LANG(?phenotype) = '')\n        }\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dcterms:identifier ?id ;\n            bmpo:stage_larva ?StageLarva .\n        ?StageLarva a brso:BiologicalResourceLarva .\n\n        OPTIONAL {?Resource dcterms:isReferencedBy ?journal .}\n        OPTIONAL {?Resource brso:derived_from ?origin .}\n        OPTIONAL {\n            ?StageLarva sio:SIO_001279 _:b2 .\n            _:b2 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n            filter(LANG(?phenotype) = '')\n        }\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dcterms:identifier ?id ;\n            bmpo:stage_pupa ?StagePupa .\n        ?StagePupa a brso:BiologicalResourcePupa .\n\n        OPTIONAL {?Resource dcterms:isReferencedBy ?journal .}\n        OPTIONAL {?Resource brso:derived_from ?origin .}  \n        OPTIONAL {\n            ?StagePupa sio:SIO_001279 _:b3 .\n            _:b3 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n            filter(LANG(?phenotype) = '')\n        }\n    } UNION {\n        ?Resource a brso:BiologicalResource ;\n            dcterms:identifier ?id ;\n            bmpo:stage_adult ?StageAdult .\n        ?StageAdult a brso:BiologicalResourceAdult .\n\n        OPTIONAL {?Resource dcterms:isReferencedBy ?journal .}\n        OPTIONAL {?Resource brso:derived_from ?origin .}  \n        OPTIONAL {\n            ?StageAdult sio:SIO_001279 _:b4 .\n            _:b4 a sio:SIO_010056 ;\n                rdfs:label ?phenotype .\n            filter(LANG(?phenotype) = '')\n        }\n    }\n    {\n        SELECT DISTINCT ?id\n        FROM <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"graph") || (depth0 != null ? lookupProperty(depth0,"graph") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"graph","hash":{},"data":data,"loc":{"start":{"line":75,"column":14},"end":{"line":75,"column":23}}}) : helper))) != null ? stack1 : "")
    + ">\n        WHERE {\n            {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_egg ?StageResource .\n                ?StageResource a brso:BiologicalResourceEgg ;\n                    sio:SIO_001279 _:b6 .\n                _:b6 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":84,"column":36},"end":{"line":84,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_egg ?StageResource .\n                ?StageResource a brso:BiologicalResourceEgg ;\n                    sio:SIO_001279 _:b7 .\n                _:b7 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":92,"column":34},"end":{"line":92,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_larva ?StageResource .\n                ?StageResource a brso:BiologicalResourceLarva ;\n                    sio:SIO_001279 _:b8 .\n                _:b8 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":100,"column":36},"end":{"line":100,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_larva ?StageResource .\n                ?StageResource a brso:BiologicalResourceLarva ;\n                    sio:SIO_001279 _:b9 .\n                _:b9 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":108,"column":34},"end":{"line":108,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_pupa ?StageResource .\n                ?StageResource a brso:BiologicalResourcePupa ;\n                    sio:SIO_001279 _:b10 .\n                _:b10 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":116,"column":36},"end":{"line":116,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_pupa ?StageResource .\n                ?StageResource a brso:BiologicalResourcePupa ;\n                    sio:SIO_001279 _:b11 .\n                _:b11 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":124,"column":34},"end":{"line":124,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_adult ?StageResource .\n                ?StageResource a brso:BiologicalResourceAdult ;\n                    sio:SIO_001279 _:b12 .\n                _:b12 a sio:SIO_010056 ;\n                    sio:SIO_000255 <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":132,"column":36},"end":{"line":132,"column":43}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } UNION {\n                ?Resource a brso:BiologicalResource ;\n                    dct:identifier ?id ;\n                    bmpo:stage_adult ?StageResource .\n                ?StageResource a brso:BiologicalResourceAdult ;\n                    sio:SIO_001279 _:b13 .\n                _:b13 a sio:SIO_010056 ;\n                    rdfs:seeAlso <"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"uri") || (depth0 != null ? lookupProperty(depth0,"uri") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"uri","hash":{},"data":data,"loc":{"start":{"line":140,"column":34},"end":{"line":140,"column":41}}}) : helper))) != null ? stack1 : "")
    + "> .\n            } \n        }\n    }\n}\nORDER BY ?id\n";
},"useData":true}]
];
